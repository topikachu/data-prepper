...
public class OTelProtoCodecTest {
    ...
    class OTelProtoDecoderTest {
        ...
        @Test
        public void testParseExportComplexLogsServiceRequest_ScopedLogs_RecursiveJson() throws IOException {
            ...
            OTelProtoCodec.OTelProtoDecoder decoderRecursiveJsonDisabled = new OTelProtoCodec.OTelProtoDecoder();
